...
- <font size=4 face="Times New Roman">**ioNetworks**, Taiwan, New-Taipei</font><img src="./assets/ioNetworks.png" align='right' height="15%" width="15%"/>
  ...
  <font face="Times New Roman">**Senior AI Algorithm Engineer**, Oct.2022-Now</font>
  - <font face="Times New Roman">Developed a novel training method combining unsupervised learning and knowledge distillation, boosting YOLOv10n accuracy by 13.3% on COCO-minitrain. Provided tools for team model improvements. Patent pending</font>
  - <font face="Times New Roman">Collaborated with MTK on a ReID project for the 2024 ISC exhibition. Designed a ReID strategy that achieved 91% accuracy under constraints on MTK edge computing chips and 83% accuracy in challenging scenarios</font>
  - <font face="Times New Roman">Developed a bus stop mask detection model using General Focal Loss, attention mechanisms, and BoF, achieving 88% accuracy on a validation set with 70° camera tilt and long-distance detection</font>
  - <font face="Times New Roman">Collaborated with Ambarella on Primax smart cameras for the 2023 CES exhibition, developing a real-time pose detection model on Ambarella chips, achieving 97% accuracy on the validation set</font>
  - <font face="Times New Roman">Improved YOLOv5s accuracy from 37.4% to 43% without compromising speed using attention mechanisms, structural re-parameterization, deep supervision (auxiliary branch), and knowledge distillation</font>
...
- <font size=4 face="Times New Roman">**Infortrend Technology**, Taiwan, New-Taipei</font><img src="./assets/infortrend.png" align='right' height="15%" width="15%"/>
  ...
  - <font face="Times New Roman">Developed Auto Tiering AI model for the Infortrend storage systems and accelerated at least 60% IO performance.</font>
    - <font face="Times New Roman">Version 1: Used XGBoost, following research papers, to predict file access within 1–6 hours. When extended to 24-hour predictions per requirements, accuracy was 80%</font>
    - <font face="Times New Roman">Final solution: Enhanced the first version by incorporating file type features and increasing interval counts. Developed a regression model to predict file temperature over time, achieving up to 92% accuracy and improving IO performance by 60%.</font>
...
- <font size=4 face="Times New Roman">**Patere Technologies, Inc.**, Taipei, Taiwan</font><img src=".\assets\patere.png" align='right' height="15%" width="15%"/>
  ...
  - <font face="Times New Roman">Confidence and speech fluency detection</font>
    ...
    - <font face="Times New Roman">Developed a rule-based project with basic speech features, reducing confidence detection error rate to 21% using RMS energy and achieving 72% accuracy in vowel frequency analysis with vowel detection and sliding windows</font>
    - <font face="Times New Roman">Explored advanced features for machine/deep learning, such as MFCC and FBank</font>
  - <font face="Times New Roman">Remote Interviewee Attention detection</font>
    - <font face="Times New Roman">Developed the algorithm to confirm the candidate or the interviewee's focus by checking their gaze and facial orientation</font>
    - <font face="Times New Roman">Achieved approximately 80% accuracy, precision, and recall on the test set.</font>
...
- <font size=4 face="Times New Roman">**Lenovo Group Ltd, Lenovo Research**, Beijing, China</font><img src=".\assets\lenovo-logo.png" align='right' height="15%" width="15%"/>
  ...
  - <font face="Times New Roman">Unmanned Store</font>
    - <font face="Times New Roman">Mainly responsible for developing the product detection model</font>
    - <font face="Times New Roman">Developed a RetinaNet-based commodity detection model for unmanned containers and retail settings. An analysis was also performed to identify factors affecting low accuracy</font>
    - <font face="Times New Roman">Achieved 86% accuracy by collecting and generating more complex data, along with BoF, quickly retrained the model</font>
    - <font face="Times New Roman">Discussed with the supervisor one of the intriguing research directions: developing automated training systems o eliminate the need for developers to intervene in every product update or release for future applications</font>
...
- <font size=4 face="Times New Roman">**Zero Zero Robotics**, Beijing, China</font><img src=".\assets\zerozero-logo.png" align='right' height="16%" width="16%"/>
  ...
  - <font face="Times New Roman">Involved in Hover 2 drone development</font>
    ...
    - <font face="Times New Roman">Researched and developed correlation filter algorithms, integrating them into the tracking function. Improved the object tracking success rate by 15% and reduced CPU usage by 5% by adding constraints and modifying the object ReID strategy</font>
...
- <font size=4 face="Times New Roman">**Design and Implementation of Real-time Long-term Single Person Tracking System**</font>
  ...
  - <font face="Times New Roman">To achieve long-term stability and real-time tracking on edge computing devices by simulating on PC</font>
  - <font face="Times New Roman">Used a 2-branch tracking mode: One branch uses the optimized OpenPose as the pedestrian detection model with the SCNCD ReID method added, while the other uses the optimized KCF as the general tracking method. OpenPose serves as the primary track, with KCF as the auxiliary</font>
  - <font face="Times New Roman">Divided the tracker into three states to facilitate the design and implementation, developing several strategies to make person tracker real-time and long-term stable</font>
...
- <font size=4 face="Times New Roman">**2D Anime Charactors Recognition**</font>
  ...
  - <font face="Times New Roman">Utilized the pretrained LBPcascade to detect anime faces and recognize them through fine-tuning Inception-v3 model</font>
  - <font face="Times New Roman">**TOP1 result is 73.25%**</font>
  - <font face="Times New Roman">a cooperation course project of Peking University and Microsoft, **reaching the final 6**</font>
...
* <font size=4 face="Times New Roman">**IBM Watson Build Competition: Clothes Master**</font>
  ...
  - <font face="Times New Roman">Utilized JavaScript and Node.js to develop both the front and back ends, responsible for the overall architecture and design and implementation of key features</font>

## <font face="Times New Roman">Skills</font>

- <font face="Times New Roman">Programming Language: Python, C++ </font>
- <font face="Times New Roman">Machine Learning Framework: PyTorch, TensorFlow </font>
