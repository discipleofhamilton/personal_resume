...
- <font size=4 face="Times New Roman">**ioNetworks**, Taiwan, New-Taipei</font><img src="./assets/ioNetworks.png" align='right' height="15%" width="15%"/>
  ...
  - <font face="Times New Roman">Developed a novel training method boosting YOLOv10n accuracy by 13.3% (patent pending)</font>
  - <font face="Times New Roman">Collaborated with MTK on a ReID project for the 2024 ISC, designing a ReID strategy that achieved 91% accuracy under constraints on MTK edge computing chips and 83% accuracy in challenging scenarios</font>
  - <font face="Times New Roman">Develop a real-time pose detection model (97% accuracy) for Ambarella+Primax smart camera at CES 2023</font>
  ...
  - <font face="Times New Roman">Enhanced YOLOv5s accuracy from 37.4% to 43% through advanded tenchiques</font>
